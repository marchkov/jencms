...
final class Template
{
    ...
    public function render(array $data): string
    {
        ...
        return strtr($template, [
            ...
            '[TITLE]' => e($data['title'] ?? $this->config['site']['name']),
            '[KEYWORDS]' => e($data['keywords'] ?? get_default_meta($this->config, 'default_keywords')),
            '[DESCRIPTION]' => e($data['description'] ?? get_default_meta($this->config, 'default_description')),
